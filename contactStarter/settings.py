"""
Django settings for contactStarter project.
...
SECRET_KEY = '4#i!*74sq!v!zyju^#v6=7e_%@_iwj&7%5(!ely3m_2lj5d_xb'
...
DMP_TEMPLATES_DIRS = [
 ...
 ################################################################
ROOT_URLCONF = 'contactStarter.urls'

WSGI_APPLICATION = 'contactStarter.wsgi.application'
